...
print("Age:",Myinfo2) #print age input by the users
print("Nationality:",Myinfo3) #print nationality input by the users
print("University:",Myinfo4) #print university input by the users
print("Location:",Myinfo5) #print location input by the users